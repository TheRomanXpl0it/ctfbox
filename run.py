            ...
            dict_to_yaml(
                {
                        ...
                        "router": {
                            ...
                            "ports": [
                                ...
                                *(
                                    ...
                                    if config.gameserver_exposed_port is not None
                                    else {}
                                ),
                            ],
                        },
                    ...
                    **(
                        ...
                        if config.teams and spawn_docker_teams
                        else {}
                    ),
                    "volumes": {"unixsk": "", "db-data": "", "incus-data": ""},
                    "networks": {
                        "externalnet": "",
                        "internalnet": "",
                        "gameserver": {
...
def router_generate_configs(config: Config, down_after_gen: bool = True):
    ...
    if not os.path.isfile("./router/configs/wg0.conf") or old_hash != current_hash:
